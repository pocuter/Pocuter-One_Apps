...
#define ACTION_TOGGLE_PIN       (getInput(BUTTON_C) & SINGLE_CLICK)
#define ACTION_NEXT_PIN         (getInput(BUTTON_B) & SINGLE_CLICK)
#define ACTION_TOGGLE_PLOTTER   (getInput(BUTTON_A) & SINGLE_CLICK)
#define ACTION_TOGGLE_UI        (getInput(BUTTON_C) & SINGLE_CLICK)
